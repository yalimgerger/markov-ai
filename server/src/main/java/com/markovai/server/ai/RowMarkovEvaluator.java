...
public class RowMarkovEvaluator implements MarkovChainEvaluator {

    private final DigitMarkovModel model;
    private final MultiSequenceExtractor extractor;
    private final String version;

    public RowMarkovEvaluator(DigitMarkovModel model, MultiSequenceExtractor extractor, String version) {
        this.model = model;
    ...
    public double[] computeScores(byte[] binary28x28) {
        // Convert flat binary to 2D int array
